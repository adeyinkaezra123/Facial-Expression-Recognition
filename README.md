...
Only tested in Ubuntu and macOS Sierra. I'm not sure if this project would work properly on'other   platforms. When problems meet, open an issue, I'll do my best to solve that.
...
python3 main.py
```
Then the program will create a window to display the scene captured by webcamera. You need press <kbd>SPACE</kbd> key to capture face in current frame and recognize the facial expression.
...
#### Issues & Suggestions
If you've got any issues and suggestions, you can create an [issue](https://github.com/adeyinkaezra123/issues/).
